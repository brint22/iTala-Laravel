    ...
    <div class="py-6" x-data="{ openClientId: null, showAppointmentsFor: null }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div class="hover-container hover-layer bg-gray-800 shadow rounded-lg p-4 transition relative">

                    <!-- Left: Clickable Area for Modal -->
                    <div @click="openClientId = {{ $client->id }}" class="cursor-pointer flex-1">
